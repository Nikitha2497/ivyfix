...
class Application(fix.Application):
	...
	def onCreate(self, sessionID): 
		print("A session is created")
		return
	def onLogon(self, sessionID): 
		print("I recevied a  message")
		return
	def onLogout(self, sessionID):
		print("I am here 1") 
		return
	def toAdmin(self, sessionID, message):
		print('sending a heart beat message??')
		print("I am here 2")
		return
	def fromAdmin(self, sessionID, message):
		print('Is this the heart beat message?')
		print("I am here 3")
		return
	def toApp(self, sessionID, message): 
		print("I am here, does it mean anything?")
		return
...
try:
	# file = sys.argv[1]
	settings = fix.SessionSettings( "settings.txt" )
	# settings = new fix.SessionSettings("temp")
